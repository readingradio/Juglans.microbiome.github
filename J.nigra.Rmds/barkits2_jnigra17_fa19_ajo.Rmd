...
its2.ds.rareotu.wsingles<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/barkits2statistics_jnigra17_2019_ajo/barkits2otutable.rarefied_jnigra17_fa19_gw.shared", header=TRUE, sep="\t",row.names = 2)
...
its2.taxonomy.ds<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/barkits2statistics_jnigra17_2019_ajo/barkits2taxonomy_jnigra17_fa19_gw.cons.taxonomy",header=TRUE,sep="\t",fill=TRUE,strip.white=TRUE,row.names=1)
...
its2.ds.rareotu.nosingles<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/barkits2statistics_jnigra17_2019_ajo/barkits2otutable.rarefied.nosingleton_jnigra17_otutable_fa19_gw_ajo.shared", header=TRUE, sep="\t")
...
```{r, warning=FALSE}
#Using the rarefied OTU tables I can generate relative abundance charts for the different taxonomic levels.To begin I first reformat the OTU table so that I can do some filtering and add taxonomy information. 
its2.ds.rareotu.nosingles.table<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/barkits2statistics_jnigra17_2019_ajo/barkits2otutable.rarefied.nosingleton_jnigra17_otutable_fa19_gw_ajo.shared", header=TRUE, sep="\t")
...
its2.ds.met.rare<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/barkits2statistics_jnigra17_2019_ajo/barkits2metadata_jnigra17_su19_ajo.txt",header=TRUE,sep="\t",fill=TRUE,strip.white=TRUE)
#I first import my rarefied OTU table that contains singletons.
its2.ds.rareotu.wsingles<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/barkits2statistics_jnigra17_2019_ajo/barkits2otutable.rarefied_jnigra17_fa19_gw.shared", header=TRUE, sep="\t")
...
```{r}
its2.ds.indicators<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/barkits2statistics_jnigra17_2019_ajo/caulosphere_indicatoranalysis_sp20_ajo.csv",header=TRUE,sep=",")
...
ggsave("its.caulosphere.indicator.png",its.caulosphere.heatmap,height = 15,width=15,dpi=300)
```
