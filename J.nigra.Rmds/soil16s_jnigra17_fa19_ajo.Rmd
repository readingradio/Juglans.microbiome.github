...
```{r}
soil.indicators<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/soil16sstatistics_jnigra17_2019_ajo/soil16smothur_jnigra17_microbiome/soil16s_indicatoranalysis_sp20_ajo.csv",header=TRUE,sep=",")
...
soil.heatmap<-pheatmap(soil.indicator.mat,
         ...
         cellwidth=10)
ggsave("soil.indicator.png",soil.heatmap,height = 15,width=15,dpi=300)
```