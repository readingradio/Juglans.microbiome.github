...
its2.soil.shared.rare<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/soilits2statistics_jnigra17_su19_ajo/soilfunguild_jnigra17_2019_ajo/soilits2otutable.rarefied_jnigra17_fa19_gw.shared", header=TRUE, sep="\t", row.names=2)

its2.soil.tax<-read.table("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/soilits2statistics_jnigra17_su19_ajo/soilfunguild_jnigra17_2019_ajo/soilits2taxonomy_jnigra17_fa19_gw.cons.taxonomy", header=TRUE, sep="\t")
```
...
# After running funguild in linux, I then import the funguild output table. 
  t.funguild.soil.1<-read.delim("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/soilits2statistics_jnigra17_su19_ajo/soilfunguild_jnigra17_2019_ajo/soilfunguildoutput.1_jnigra17_fa19.25.11_ajo.guilds.txt",header=TRUE,sep="\t",fill=TRUE,strip.white=TRUE)

t.funguild.soil.2<-read.delim("/Volumes/AaronOnufrakMac/researchprojects_2019.2022_ajo/j.nigra_microbiome_2017_ajo_gmw/soilits2statistics_jnigra17_su19_ajo/soilfunguild_jnigra17_2019_ajo/soilfunguildoutput.2_jnigra17_fa19.25.11_ajo.guilds.txt",header=TRUE,sep="\t",fill=TRUE,strip.white=TRUE)
